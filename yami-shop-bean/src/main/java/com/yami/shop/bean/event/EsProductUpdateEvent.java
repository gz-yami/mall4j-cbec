...
public class EsProductUpdateEvent {
    ...
    public EsProductUpdateEvent(List<EsProdUpdateVO> prodList, EsOperationType esOperationType) {
        this.prodList = prodList;
        this.esOperationType = esOperationType;
    }

    public EsProductUpdateEvent(Long id, List<Long> ids, EsOperationType esOperationType) {
        this.id = id;
        this.ids = ids;
        this.esOperationType = esOperationType;
    }
